...
<body>
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#000080">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFF">Student feedback System</a>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				...
				Student Feedback system for College in PHP 
Here we have developed the a Student feedback system, which is generally used in the college to rate the faculty based on the performance...Here we have 2 modules such as administrator, student.
...
We can start the development from the login page, where we have given the option to login as admin and student...Here since we have only one admin account, so no need to create the a database to store admin info...so select admin in the radio button and login 
...
If you entered the student user and password and selected student option, then it will show all student information and let you enter the feedback based on the subject..
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#000080">
		<span style="color:#FFF"><p>Copyright &copy; 2019 Pushpak</span>
	</div>
    <!-- jQuery -->
